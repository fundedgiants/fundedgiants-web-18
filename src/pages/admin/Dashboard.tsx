      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
          ...
          <CardContent>
            {isLoadingUsers ? (
              <Skeleton className="h-8 w-20" />
                ...
                <div className="text-sm font-bold text-destructive">Error loading</div>
            ) : (
        ...
        <Card className="bg-card/30 border-primary/30">
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">Data will be populated soon</p>
          </CardContent>
        </Card>
        <Card className="bg-card/30 border-primary/30">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
        ...
        <Card className="bg-card/30 border-primary/30">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">New Affiliates</CardTitle>
